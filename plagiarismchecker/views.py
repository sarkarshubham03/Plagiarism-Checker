...
from docx import *
from plagiarismchecker.algorithm import fileSim
import PyPDF2 
...
def twofiletest1(request):
    ...
    if request.POST['q1'] != '' and request.POST['q2'] != '': 
        ...
        result = fileSim.findFileSimilarity(request.POST['q1'],request.POST['q2'])
...
def twofilecompare1(request):
    ...
    result = fileSim.findFileSimilarity(value1,value2)
